  ...
  return (
    <div className="min-h-screen bg-[#0a1a14] flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md text-center">
        ...
        <p className="text-gray-400 text-base mb-2">GentleChase is ready to start recovering your invoices.</p>
        <p className="text-gray-600 text-sm mb-10">Your 30-day free trial has started. No credit card needed.</p>
        ...
        <div className="bg-[#0f1f18] border border-gray-700/60 rounded-2xl p-6 mb-8 text-left">
          {[
            ...
            <div key={item.label} className="flex items-center gap-3 py-2 border-b border-gray-800/60 last:border-0">
              <div className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 ${item.done ? "bg-emerald-700" : "bg-gray-700"}`}>
        ...
        <p className="text-gray-600 text-xs">Redirecting automatically in {countdown}s…</p>
      </div>
    </div>
  );
}